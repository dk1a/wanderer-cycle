...
import QueryErrorDetailed from "../QueryErrorDetailed";
  ...
  return (
    <section>
      ...
      <div className="flex items-center space-x-4">
        ...
        <MethodButton name="mint" disabled={mintIdentifiedLoot.isBusy} onClick={mintCallback} />
      ...
      <QueryErrorDetailed
        queryResult={mintIdentifiedLoot.prepared}
        className="items-start"
        comment="mint error, likely due to batchSize:"
      />
    </section>
  );
}
