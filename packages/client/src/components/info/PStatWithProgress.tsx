...
export function PStatWithProgress({ name, baseLevel, buffedLevel, experience }: PStatsWithProgressProps) {
  ...
  return (
    <div className="p-2 flex">
      ...
      <span className="w-52">
        <span className="text-dark-key">{name}</span>: <span className="text-dark-number">{buffedLevel}</span>
