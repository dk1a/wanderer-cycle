...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("RNGPrecommit")));
bytes32 constant RNGPrecommitTableId = _tableId;
...
library RNGPrecommit {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("RNGPrecommit", _fieldNames);
  }
