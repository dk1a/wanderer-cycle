...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("BossesDefeated")));
bytes32 constant BossesDefeatedTableId = _tableId;
...
library BossesDefeated {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("BossesDefeated", _fieldNames);
  }
  ...
  /** Get value */
  function get(uint256 entity) internal view returns (uint256[] memory value) {
  ...
  function get(IStore _store, uint256 entity) internal view returns (uint256[] memory value) {
    bytes32[] memory _primaryKeys = new bytes32[](1);
    _primaryKeys[0] = bytes32(uint256((entity)));
  ...
  /** Set value */
  function set(uint256 entity, uint256[] memory value) internal {
    bytes32[] memory _primaryKeys = new bytes32[](1);
    _primaryKeys[0] = bytes32(uint256((entity)));
  ...
  function set(IStore _store, uint256 entity, uint256[] memory value) internal {
    bytes32[] memory _primaryKeys = new bytes32[](1);
    _primaryKeys[0] = bytes32(uint256((entity)));
  ...
  function push(uint256 entity, uint256 _element) internal {
    bytes32[] memory _primaryKeys = new bytes32[](1);
    _primaryKeys[0] = bytes32(uint256((entity)));
  ...
  function push(IStore _store, uint256 entity, uint256 _element) internal {
    bytes32[] memory _primaryKeys = new bytes32[](1);
    _primaryKeys[0] = bytes32(uint256((entity)));
  ...
  function update(uint256 entity, uint256 _index, uint256 _element) internal {
    bytes32[] memory _primaryKeys = new bytes32[](1);
    _primaryKeys[0] = bytes32(uint256((entity)));
  ...
  function update(IStore _store, uint256 entity, uint256 _index, uint256 _element) internal {
    bytes32[] memory _primaryKeys = new bytes32[](1);
    _primaryKeys[0] = bytes32(uint256((entity)));
