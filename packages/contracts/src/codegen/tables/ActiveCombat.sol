...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("ActiveCombat")));
bytes32 constant ActiveCombatTableId = _tableId;
...
library ActiveCombat {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("ActiveCombat", _fieldNames);
  }
