...
library SkillNameToEntity {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "SkillNameToEntit", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74620000000000000000000000000000536b696c6c4e616d65546f456e746974);
