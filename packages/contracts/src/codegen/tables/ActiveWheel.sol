...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("ActiveWheel")));
bytes32 constant ActiveWheelTableId = _tableId;
...
library ActiveWheel {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("ActiveWheel", _fieldNames);
  }
