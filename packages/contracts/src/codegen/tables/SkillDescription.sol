...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("SkillDescription")));
bytes32 constant SkillDescriptionTableId = _tableId;
...
library SkillDescription {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("SkillDescription", _fieldNames);
  }
  ...
  /** Get value */
  function get(uint256 entity) internal view returns (string memory value) {
  ...
  function get(IStore _store, uint256 entity) internal view returns (string memory value) {
    bytes32[] memory _primaryKeys = new bytes32[](1);
    _primaryKeys[0] = bytes32(uint256((entity)));
  ...
  /** Set value */
  function set(uint256 entity, string memory value) internal {
    bytes32[] memory _primaryKeys = new bytes32[](1);
    _primaryKeys[0] = bytes32(uint256((entity)));
  ...
  function set(IStore _store, uint256 entity, string memory value) internal {
    bytes32[] memory _primaryKeys = new bytes32[](1);
    _primaryKeys[0] = bytes32(uint256((entity)));
  ...
  function push(uint256 entity, string memory _slice) internal {
    bytes32[] memory _primaryKeys = new bytes32[](1);
    _primaryKeys[0] = bytes32(uint256((entity)));
  ...
  function push(IStore _store, uint256 entity, string memory _slice) internal {
    bytes32[] memory _primaryKeys = new bytes32[](1);
    _primaryKeys[0] = bytes32(uint256((entity)));
  ...
  function update(uint256 entity, uint256 _index, string memory _slice) internal {
    bytes32[] memory _primaryKeys = new bytes32[](1);
    _primaryKeys[0] = bytes32(uint256((entity)));
  ...
  function update(IStore _store, uint256 entity, uint256 _index, string memory _slice) internal {
    bytes32[] memory _primaryKeys = new bytes32[](1);
    _primaryKeys[0] = bytes32(uint256((entity)));
