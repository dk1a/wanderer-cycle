...
library LifeCurrent {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "LifeCurrent", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746200000000000000000000000000004c69666543757272656e740000000000);
