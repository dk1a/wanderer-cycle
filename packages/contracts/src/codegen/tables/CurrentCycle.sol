...
library CurrentCycle {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "CurrentCycle", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462000000000000000000000000000043757272656e744379636c6500000000);
