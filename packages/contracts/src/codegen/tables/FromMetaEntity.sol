...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("FromMetaEntity")));
bytes32 constant FromMetaEntityTableId = _tableId;

library FromMetaEntity {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("FromMetaEntity", _fieldNames);
  }
