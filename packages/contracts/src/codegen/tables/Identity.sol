...
library Identity {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "Identity", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746200000000000000000000000000004964656e746974790000000000000000);
