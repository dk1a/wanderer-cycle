...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("DefaultWheel")));
bytes32 constant DefaultWheelTableId = _tableId;
...
library DefaultWheel {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("DefaultWheel", _fieldNames);
  }
