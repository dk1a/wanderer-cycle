...
library DurationIdxMap {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "DurationIdxMap", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746200000000000000000000000000004475726174696f6e4964784d61700000);
