...
library EffectDuration {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "EffectDuration", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746200000000000000000000000000004566666563744475726174696f6e0000);
