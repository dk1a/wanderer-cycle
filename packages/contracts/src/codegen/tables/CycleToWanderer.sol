...
library CycleToWanderer {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "CycleToWanderer", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746200000000000000000000000000004379636c65546f57616e646572657200);
