...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("LootAffixes")));
bytes32 constant LootAffixesTableId = _tableId;
...
library LootAffixes {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("LootAffixes", _fieldNames);
  }
