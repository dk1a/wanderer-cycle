...
library DurationIdxList {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "DurationIdxList", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746200000000000000000000000000004475726174696f6e4964784c69737400);
