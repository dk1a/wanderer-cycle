...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("RNGRequestOwner")));
bytes32 constant RNGRequestOwnerTableId = _tableId;
...
library RNGRequestOwner {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("RNGRequestOwner", _fieldNames);
  }
