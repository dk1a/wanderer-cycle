...
library CycleTurns {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "CycleTurns", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746200000000000000000000000000004379636c655475726e73000000000000);
