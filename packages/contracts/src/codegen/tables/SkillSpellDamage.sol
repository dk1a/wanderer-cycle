...
library SkillSpellDamage {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "SkillSpellDamage", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74620000000000000000000000000000536b696c6c5370656c6c44616d616765);
