...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("SlotEquipment")));
bytes32 constant SlotEquipmentTableId = _tableId;
...
library SlotEquipment {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("SlotEquipment", _fieldNames);
  }
