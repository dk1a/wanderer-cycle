...
using { toBytes32, eq as ==, ne as != } for EquipmentType global;

function toBytes32(EquipmentType equipmentType) pure returns (bytes32) {
  return EquipmentType.unwrap(equipmentType);
}
