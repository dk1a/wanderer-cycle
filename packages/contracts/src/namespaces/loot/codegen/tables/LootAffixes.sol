...
library LootAffixes {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "loot", name: "LootAffixes", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74626c6f6f74000000000000000000004c6f6f74416666697865730000000000);
