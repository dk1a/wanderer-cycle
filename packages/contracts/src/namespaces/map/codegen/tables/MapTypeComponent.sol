...
library MapTypeComponent {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "map", name: "MapTypeComponent", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74626d617000000000000000000000004d617054797065436f6d706f6e656e74);
