...
library SkillTemplateDuration {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "SkillTemplateDur", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74620000000000000000000000000000536b696c6c54656d706c617465447572);
