...
library ActiveGuise {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "ActiveGuise", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462000000000000000000000000000041637469766547756973650000000000);
