...
library GuisePrototype {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "GuisePrototype", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74620000000000000000000000000000477569736550726f746f747970650000);
