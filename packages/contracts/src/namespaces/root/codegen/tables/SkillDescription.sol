...
library SkillDescription {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "SkillDescription", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74620000000000000000000000000000536b696c6c4465736372697074696f6e);
