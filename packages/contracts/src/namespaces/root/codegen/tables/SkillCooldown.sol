...
library SkillCooldown {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "SkillCooldown", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74620000000000000000000000000000536b696c6c436f6f6c646f776e000000);
