...
library LearnedSkills {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "LearnedSkills", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746200000000000000000000000000004c6561726e6564536b696c6c73000000);
