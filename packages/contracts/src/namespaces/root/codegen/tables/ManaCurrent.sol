...
library ManaCurrent {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "ManaCurrent", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746200000000000000000000000000004d616e6143757272656e740000000000);
