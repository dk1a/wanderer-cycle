...
library GuiseSkills {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "GuiseSkills", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746200000000000000000000000000004775697365536b696c6c730000000000);
