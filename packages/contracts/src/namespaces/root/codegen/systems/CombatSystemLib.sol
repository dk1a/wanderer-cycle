...
// equivalent to WorldResourceIdLib.encode({ typeId: RESOURCE_SYSTEM, namespace: "", name: "CombatSystem" }))
CombatSystemType constant combatSystem = CombatSystemType.wrap(
  0x73790000000000000000000000000000436f6d62617453797374656d00000000
);
