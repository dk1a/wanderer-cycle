...
library CycleTurns {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "cycle", name: "CycleTurns", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74626379636c650000000000000000004379636c655475726e73000000000000);
