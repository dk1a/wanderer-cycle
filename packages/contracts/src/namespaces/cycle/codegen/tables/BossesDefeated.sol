...
library BossesDefeated {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "cycle", name: "BossesDefeated", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74626379636c65000000000000000000426f7373657344656665617465640000);
