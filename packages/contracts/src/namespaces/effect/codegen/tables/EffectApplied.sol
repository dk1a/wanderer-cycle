...
library EffectApplied {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "effect", name: "EffectApplied", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746265666665637400000000000000004566666563744170706c696564000000);
