...
library EffectDuration {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "effect", name: "EffectDuration", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746265666665637400000000000000004566666563744475726174696f6e0000);
