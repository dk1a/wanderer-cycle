...
library StatmodIdxList {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "statmod", name: "StatmodIdxList", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462737461746d6f6400000000000000537461746d6f644964784c6973740000);
