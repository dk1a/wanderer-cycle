...
library StatmodIdxMap {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "statmod", name: "StatmodIdxMap", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462737461746d6f6400000000000000537461746d6f644964784d6170000000);
