...
library OwnedBy {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "common", name: "OwnedBy", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462636f6d6d6f6e00000000000000004f776e65644279000000000000000000);
