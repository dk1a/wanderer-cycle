...
struct SkillTemplateDurationData {
  bytes32 timeId;
  uint256 timeValue;
}

library SkillTemplateDuration {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "skill", name: "SkillTemplateDur", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462736b696c6c000000000000000000536b696c6c54656d706c617465447572);
   ...
   */
  function get(bytes32 entity) internal view returns (SkillTemplateDurationData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = entity;
   ...
   * @notice Get the full data.
   */
  function _get(bytes32 entity) internal view returns (SkillTemplateDurationData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = entity;
   ...
   */
  function set(bytes32 entity, SkillTemplateDurationData memory _table) internal {
   ...
   * @notice Set the full data using the data struct.
   */
  function _set(bytes32 entity, SkillTemplateDurationData memory _table) internal {
    bytes memory _staticData = encodeStatic(_table.timeId, _table.timeValue);
  ...
  function decode(
    ...
    EncodedLengths,
    bytes memory
  ) internal pure returns (SkillTemplateDurationData memory _table) {
