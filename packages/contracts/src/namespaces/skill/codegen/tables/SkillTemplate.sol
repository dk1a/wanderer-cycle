...
library SkillTemplate {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "skill", name: "SkillTemplate", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462736b696c6c000000000000000000536b696c6c54656d706c617465000000);
