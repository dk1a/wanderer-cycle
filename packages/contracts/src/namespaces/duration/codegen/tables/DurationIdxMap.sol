...
library DurationIdxMap {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "duration", name: "DurationIdxMap", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74626475726174696f6e0000000000004475726174696f6e4964784d61700000);
