...
library ManaCurrent {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "charstat", name: "ManaCurrent", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746263686172737461740000000000004d616e6143757272656e740000000000);
