...
library LifeCurrent {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "charstat", name: "LifeCurrent", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746263686172737461740000000000004c69666543757272656e740000000000);
