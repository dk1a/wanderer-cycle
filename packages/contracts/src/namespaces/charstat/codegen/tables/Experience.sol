...
library Experience {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "charstat", name: "Experience", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74626368617273746174000000000000457870657269656e6365000000000000);
