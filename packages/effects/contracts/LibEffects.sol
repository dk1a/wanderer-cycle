...
import { EffectScopeComponent, ID as EffectScopeComponentID } from "./EffectScopeComponent.sol";
import { EffectValueComponent, ID as EffectValueComponentID } from "./EffectValueComponent.sol";

library LibEffects {
    // ========== UTILS ==========

    function svc(address components) internal view returns (SVComponents memory) {
        return getSVComponents(components, EffectScopeComponentID, EffectValueComponentID);
    }
